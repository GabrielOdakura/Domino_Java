...
public class Jogo {
    ...
    private Domino determinarQuemComeca() {
        ...
        if (maiorMJ1 == null && maiorMJ2 == null) {
            ...
            System.out.println("MJ1 começa com " + maiorMJ1);
            ...
            System.out.println("MJ2 começa com " + maiorMJ2);
    ...
    public void jogar_peca(int id_peca, String lado){
        if(vez_jogador){
            ja_comprou = false; // lembrar de colocar só quando o jogador realmente conseguiu inserir a peça
        }else{
            ja_comprou = false; // lembrar de colocar só quando o jogador realmente conseguiu inserir a peça
        }
    }
